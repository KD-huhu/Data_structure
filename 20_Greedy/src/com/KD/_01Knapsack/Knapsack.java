...
public class Knapsack {
	public static void main(String[] args) {
		select("Value leading", (Article a1, Article a2) -> {
			return a2.value - a1.value;
		});
		select("Weight leading", (Article a1, Article a2) -> {
			return a1.weight - a2.weight;
		});
		select("Value density leading", (Article a1, Article a2) -> {
